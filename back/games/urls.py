...
urlpatterns = [
    path('<int:league_id>', view_matchs, name='view_matchs'),
    ...
    path('<int:game_result_request_id>', approve_match_result_request, name='approve_match_result_request'),
    path('<int:game_result_request_id>', reject_match_result_request, name='reject_match_result_request'),
]
